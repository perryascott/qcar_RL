...
class Learner:
    def __init__(self, buffer_name, network_name, new_network, buffer_capacity=100000, batch_size=64, num_states=2, num_actions=2):
        ...
        # calculate reward using calc_reward()
        #self.calc_reward()
        ...
        #convert layers from float32 to float64's
...
def main():
    ...
    learner = Learner(buffer_name, network_name, new_network, 20000, 64, num_states, num_actions)
